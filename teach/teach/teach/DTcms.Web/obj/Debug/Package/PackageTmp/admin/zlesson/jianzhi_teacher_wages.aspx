        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><%#decimal.Parse(getKeShiDanJia(int.Parse(Eval("manager_id").ToString()),int.Parse(Eval("stu_id").ToString())))*decimal.Parse(Eval("lesson_count").ToString()) %></td>
