    ...
    public partial class list : DTcms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                this.ddlProperty.DataSource = new DTcms.BLL.manager().GetList("(role_id=9 or role_id=15) and xiaoqu="+model.xiaoqu);
                ...
                if (model.role_id != 1 && model.role_id != 15 && model.role_id != 16)
                {
                    ...
                    RptBind("id>0 and user_id=" + model.id + CombSqlTxt(this.channel_id, this.category_id, this.keywords, this.property, this.grade, this.qianyue), "Expr2 desc");
                }
                else
                {
                    RptBind("id>0 and xiaoqu=" + model.xiaoqu + "" + CombSqlTxt(this.channel_id, this.category_id, this.keywords, this.property, this.grade, this.qianyue), "Expr2 desc");
                }
            }
        }
