...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="manager_edit.aspx?action=<%=ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加管理员</b></span></a>
        ...
        <div class="select_box">
            ...
            <asp:DropDownList ID="ddlProperty" runat="server" CssClass="select2" AutoPostBack="True" OnSelectedIndexChanged="ddlProperty_SelectedIndexChanged" >
                <asp:ListItem Value="" Selected="True">所有校区</asp:ListItem>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="manager_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("user_name")%></a></td>
        <td><%#new DTcms.BLL.manager_role().GetTitle(Convert.ToInt32(Eval("role_id")))%></td>
        <td><%#Eval("real_name")%></td>
        <td><%#Eval("telephone")%></td>
        <td><%#Eval("xiaoqu").ToString()=="1" ? "台江校区" : Eval("xiaoqu").ToString()=="2" ? "福清校区" : "鼓楼校区"%></td>
        <td><%#string.Format("{0:g}",Eval("add_time"))%></td>
        <td align="center">
          <%#Eval("is_lock").ToString().Trim() == "0" ? "<img title=\"正常\" src=\"../images/icon_correct.png\" />" : "<img title=\"禁用\" src=\"../images/icon_disable.png\" />"%>
        </td>
        <td align="center"><a href="manager_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
