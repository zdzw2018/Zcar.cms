...
<form id="form1" runat="server">
       ...
       <th width="6%" align="center">年级</th>
        ...
        <th width="6%" align="center">综合费</th>
          <th width="8%" align="center">教育咨询费</th>
           <th width="12%" align="center">未支付教育咨询费</th>
        <th width="7%">合同状态</th>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><%#Convert.ToDecimal(Eval("contract_advice_price_surplus").ToString()).ToString("0.0")%></td>
    ...
    <tr>
       ...
       <td align="center"><%=price.ToString("0.0") %></td>
       <td align="center">-</td>
       <td align="center">-</td>
       <td align="center">-</td>
       <td align="center">-</td>
