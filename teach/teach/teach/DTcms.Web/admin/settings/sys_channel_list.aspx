...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
		    ...
		    <a href="sys_channel_edit.aspx?action=<%=ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加频道</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="sys_channel_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
        <td><%#Eval("name")%></td>
        <td><%#Eval("model_title")%></td>
        <td align="center"><%#Eval("sort_id")%></td>
        <td align="center"><a href="sys_channel_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
    </table>
