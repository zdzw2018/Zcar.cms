    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>权限：</th>
                <td>
                    <label style="margin:0;"><input type="checkbox" class="cball" onclick="SelectedItems(this, 'config');" /><b>基本设置</b></label>
                </td>
            </tr>
            <tr>
                <th></th>
            ...
            <tr>
                <th></th>
                <td>
                    <label style="margin:0;"><input type="checkbox" class="cball" onclick="SelectedItems(this, 'other');" /><b>基本设置</b></label>
                </td>
            </tr>
            <tr>
                <th></th>
                <td class="item_list">
                    <ul>
                        ...
                        <li>
                            <asp:HiddenField ID="hidId" Value="0" runat="server" />
                            <asp:HiddenField ID="hidName" Value='<%#Eval("name")%>' runat="server" />
                            <label><input type="checkbox" runat="server" id="cblNavName" value='<%#Eval("value")%>' class="other" /><%#Eval("text")%></label>
                        </li>
                        </ItemTemplate>
                        </asp:Repeater>
                    </ul>
