...
<script type="text/javascript">
    ...
    function getJianZhi() {
        ...
        var value = $("#<%=ddlRoleId.ClientID%>").val();
        if (value == 11) {
            $("#jianzhi").show();
        } else {
            $("#jianzhi").hide();
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>管理角色：</th>
                <td>
                    <asp:DropDownList ID="ddlRoleId" runat="server" CssClass="select2 required" onchange="getJianZhi()" />
                </td>
            </tr>
            <tr>
                <th>账户状态：</th>
                ...
                <tr style="display:none;" id="jianzhi">
                <th>是否兼职：</th>
                <td>
                    <asp:RadioButtonList ID="rblIsJianZhi" runat="server"  RepeatDirection="Horizontal" RepeatLayout="Flow">
            ...
            <tr>
                <th>所属年级：</th>
                <td><asp:DropDownList ID="txtgrade" runat="server" CssClass="select"></asp:DropDownList></td>
            </tr>
            <tr>
                <th>课程科目：</th>
                <td><asp:CheckBoxList runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" ID="txtlesson">
               ...
               <td><asp:DropDownList ID="ddlXiaoQu" runat="server" CssClass="select">
                        <asp:ListItem Value="1">台江校区</asp:ListItem>
                        <asp:ListItem Value="2">福清校区</asp:ListItem>
                    <asp:ListItem Value="3">鼓楼校区</asp:ListItem>
