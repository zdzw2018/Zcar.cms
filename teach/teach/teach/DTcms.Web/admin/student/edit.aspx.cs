    ...
    public partial class edit : DTcms.Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            if (model_contract != null) 
            {
                ...
                txtcontract_give_lesson.Text = model_contract.give_lesson.ToString();
                txtOneSeveral.Text = model_contract.one_several.ToString();
                txtKeShiMultiple.Text = model_contract.keshi_multiple.ToString();
        ...
        private bool DoAdd()
        {
            ...
            model.stu_lesson = Convert.ToDecimal(txtcontract_lesson.Text);
            ...
            model_contract.contract_advice_price = Convert.ToDecimal(txtcontract_lesson.Text) * Convert.ToDecimal(txtcontract_lesson_price.Text.Trim());
            model_contract.contract_advice_price_surplus = Convert.ToDecimal(txtcontract_advice_price_surplus.Text.Trim());
            model_contract.contract_lesson = Convert.ToDecimal(txtcontract_lesson.Text);
            ...
            model_contract.xiaoqu = GetAdminInfo().xiaoqu;
            model_contract.give_lesson = decimal.Parse(txtcontract_give_lesson.Text.Trim());
            model_contract.keshi_multiple = decimal.Parse(txtKeShiMultiple.Text.Trim());
            model_contract.one_several = int.Parse(txtOneSeveral.Text.Trim());
