<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list_teach_lesson.aspx.cs" Inherits="DTcms.Web.admin.student.list_teach_lesson" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 任课老师安排 &gt; 学员名称：<asp:Label ID="lbluser_name" runat="server"></asp:Label> 年级：<asp:Label ID="lblgrade" runat="server"></asp:Label></div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="edit_fp.aspx?action=<%=ActionEnum.Add %>&channel_id=<%=this.channel_id %>&user_id=<%=user_id %>" class="tools_btn"><span><b class="add">任课老师</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><a href="edit_fp.aspx?channel_id=<%#this.channel_id %>&action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>&user_id=<%=this.user_id %>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
