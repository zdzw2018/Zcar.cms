<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shangke.aspx.cs" Inherits="DTcms.Web.admin.bmyj.shangke" %>
...
<body>
    ...
    <FooterTemplate>
         <tr>
            ...
            <td  align="center"> - </td>
            <td  align="center"> - </td>
            <td  align="center"> <%=totalnewmoney%> </td>
            <td align="center"><%=totalrealmoney%></td>
            <td  align="center"><%=totalhetong%></td>
           <td  align="center"><%=total4.ToString("0.0") %></td>
             <td  align="center"><%=total5.ToString("0.0") %></td>
        </tr>
