...
namespace DTcms.Model
{
    ...
    public class siteconfig
    {
        ...
        private string _sysgrade = "";//年级
        private string _sysschool = "";//学校
        private string _syscollection = "";//收集途径

        public string syscollection
        {
            get { return _syscollection; }
            set { _syscollection = value; }
        }
        /// <summary>
        /// 学校
        /// </summary>
        ...
        {
            get { return _sysschool; }
            set { _sysschool = value; }
        }
        /// <summary>
        /// 年级
        /// </summary>
