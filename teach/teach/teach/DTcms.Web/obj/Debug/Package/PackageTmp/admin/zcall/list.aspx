<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="DTcms.Web.admin.zcall.list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 来访资源管理 &gt; 管理列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
        ...
        <div class="select_box">
            请选择：<asp:DropDownList ID="ddlProperty" runat="server" CssClass="select2" AutoPostBack="True" onselectedindexchanged="ddlProperty_SelectedIndexChanged">
                    <asp:ListItem Value="" Text="请选择了解途径"></asp:ListItem>
            ...
            <asp:DropDownList ID="txtGrade" runat="server" CssClass="select2" 
                AutoPostBack="True" onselectedindexchanged="txtGrade_SelectedIndexChanged"></asp:DropDownList>
                &nbsp;<asp:DropDownList ID="ddlZiXunShi" AutoPostBack="true" 
                CssClass="select2" runat="server" 
                onselectedindexchanged="ddlZiXunShi_SelectedIndexChanged">
            </asp:DropDownList>
	    </div>
    </div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th width="6%">选择</th>
        <th align="center" width="15%">来电时间</th>
        <th align="center">学生姓名</th>
        <th align="center" width="10%">家长姓名</th>
        <th align="center" width="10%">学校</th>
        <th align="center" width="10%">年级</th>
        <th width="10%" align="center">了解途径</th>
