...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
		    ...
		    <a href="sys_model_edit.aspx?action=<%=ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加模型</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="sys_model_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
        <td align="center"><%#Eval("sort_id")%></td>
        <td align="center"><%#Convert.ToInt32(Eval("is_sys")) == 1 ? "是" : "否"%></td>
        <td align="center"><a href="sys_model_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
    </table>
