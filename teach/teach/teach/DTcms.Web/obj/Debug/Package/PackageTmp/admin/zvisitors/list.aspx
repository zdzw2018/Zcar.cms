<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="DTcms.Web.admin.zvisitors.list" %>
...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
        ...
        <div class="select_box">
            ...
            <asp:DropDownList ID="ddlvisiting_nature"  runat="server" CssClass="select2" AutoPostBack="True" onselectedindexchanged="ddlProperty_SelectedIndexChanged">
                    <asp:ListItem Value="" Text="来访性质"></asp:ListItem>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th width="6%">选择</th>
        <th width="10%" align="center">来访时间</th>
        <th width="15%" align="center">学生姓名</th>
        <th align="center" width="15%">家长姓名</th>     
        <th align="center" width="10%">学校</th>
        <th align="center" width="10%">年级</th>
        <th width="10%" align="center">来访性质</th>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><%#Eval("visiting_nature")%></td>
