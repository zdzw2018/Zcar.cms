<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="DTcms.Web.admin.work_log.list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 工作日志管理 &gt; 管理列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><a href="edit.aspx?channel_id=<%#this.channel_id %>&action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Convert.ToDateTime(Eval("work_date")).ToString("yyyy-MM-dd")%></a></td>
        <td align="center"><%#Eval("real_name") %></td>
        <td align="center"><%#Eval("work_content") %></td>
