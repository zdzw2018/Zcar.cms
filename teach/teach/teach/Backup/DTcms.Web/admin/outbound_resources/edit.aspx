<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="DTcms.Web.admin.outbound_resources.edit" %>
...
<body class="mainbody">
    ...
    <div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; 外呼资源管理 &gt; 编辑信息</div>
    <div id="contentTab">
    <ul class="tab_nav">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>学生姓名：</th>
                <td><asp:TextBox ID="txtstu_name"  runat="server" CssClass="txtInput normal" maxlength="100" ></asp:TextBox></td>
            </tr>
             <tr>
                <th>联系电话：</th>
            ...
            <tr>
             ...
             <tr>
              ...
              <tr>
                <th>回访内容：</th>
                <td><asp:TextBox ID="txtvisit_content" runat="server" maxlength="255" TextMode="MultiLine" CssClass="small" /></td>
            </tr>
