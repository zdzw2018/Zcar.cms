<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_edit.aspx.cs" Inherits="DTcms.Web.admin.photo.attribute_edit" ValidateRequest="false" %>
...
<form id="form1" runat="server">
    <div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; 图文模块 &gt; 编辑扩展属性</div>
<div id="contentTab">
    <ul class="tab_nav">
