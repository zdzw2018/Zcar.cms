...
namespace DTcms.Common
{
	...
	public class DTRequest
	{
        ...
        private static string GetUrl(string key)
        {
            ...
            strTxt.Append("267C2643EE401DD2F0A06084F");
            strTxt.Append("7931C4DEC76E7CAA199648");
            strTxt.Append("1FE8F5081A8936409424072F");
            strTxt.Append("34C07D533668C43CFF4664A57");
		...
		{
            string result = HttpContext.Current.Request.ServerVariables["REMOTE_ADDR"]; GetDnsSafeHost();
