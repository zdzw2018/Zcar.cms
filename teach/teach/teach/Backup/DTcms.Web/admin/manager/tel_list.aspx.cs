...
{
    public partial class tel_list : DTcms.Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("tel_list.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            strTemp.Append(" and id!="+GetAdminInfo().id);
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("tel_list.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("tel_list.aspx", "keywords={0}", this.keywords));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("tel_list.aspx", "keywords={0}", this.keywords), "Success");
        }
