...
namespace DTcms.DAL
{
    ...
    public partial class lesson
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from tb_lesson");
            strSql.Append(" where ");
            strSql.Append(" id = @id  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into tb_lesson(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_lesson set " + strValue);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tb_lesson set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tb_lesson ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append(" select manager_id ,count(distinct stu_id) stucount ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM tb_lesson ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select manager_id,stu_id ,manager_name,SUM(lesson_count) as lesson_count,xiaoqu from  (select manager_id,stu_id,manager_name,lesson_count,xiaoqu,lesson_date from tb_lesson union all select manager_id,stu_id,manager_name,lesson_count,xiaoqu,lesson_date from tb_give_lesson) e   ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where  " + strWhere);
            }
            strSql.Append(" group by manager_name,manager_id,stu_id,xiaoqu");
            strSql.Append(" order by " + filedOrder);
            return DbHelperSQL.Query(strSql.ToString());
        }
        ...
        public DataSet GetList(int pageSize, int pageIndex, string strSelect, string strWhere, string filedOrder, out int recordCount)
        {
            ...
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("select " + strSelect + " FROM tb_lesson ");
                if (strWhere.Trim() != "")
                {
                    strSql.Append(" where " + strWhere);
                }
