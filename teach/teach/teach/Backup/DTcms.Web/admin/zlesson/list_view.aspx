...
<body class="mainbody">
    ...
    <div class="navigation">
       <a href="javascript:history.go(-1);" class="back">后退</a> 首页 &gt; 课时安排管理 &gt; 管理列表</div>
    <div class="tools_box">
        <div class="tools_bar">
            ...
            <a href="edit.aspx?stuid=<%=this.stuid%>&channel_id=<%=this.channel_id %>" class="tools_btn"><span><b class="add">添加课时</b></span></a>
        </div>
        ...
        <ItemTemplate>
            <tr>
                ...
                <%if (GetAdminInfo().role_id != 11)
                  { %>
                <td align="center">
                    <a href="edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>&stuid=<%#Eval("stu_id") %>&channel_id=<%=this.channel_id %>">
