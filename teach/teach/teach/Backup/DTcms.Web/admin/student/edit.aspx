...
<body class="mainbody">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
             ...
             <tr>
                <th>签约来源：</th>
                <td><asp:DropDownList ID="ddlQianYue" runat="server">
    ...
    <div class="tab_con">
        <table class="form_table">
            ...
            <tr>
                <th>教育咨询费 ：</th>
                <td><asp:TextBox ID="txtcontract_advice_price"   runat="server" CssClass="txtInput normal" maxlength="100" ></asp:TextBox>(注：教育咨询费=购买课时*课时单价)</td>
            </tr>
            <tr>
                <th>未支付教育咨询费：</th>
