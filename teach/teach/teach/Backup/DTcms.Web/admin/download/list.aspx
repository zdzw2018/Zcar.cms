...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 下载模块 &gt; 管理列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="edit.aspx?action=<%=ActionEnum.Add %>&channel_id=<%=this.channel_id %>" class="tools_btn"><span><b class="add">添加下载</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="edit.aspx?channel_id=<%#this.channel_id %>&action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
