...
namespace DTcms.DAL
{
    ...
    public partial class sys_model
    {
        ...
        public bool Update(DTcms.Model.sys_model model)
        {
            ...
            {
                StringBuilder strSql2;
                foreach (DTcms.Model.sys_model_nav models in model.sys_model_navs)
                {
                    strSql2 = new StringBuilder();
                    if (models.id > 0)
                    {
        ...
        public DTcms.Model.sys_model GetModel(int id)
        {
            ...
            DTcms.Model.sys_model model = new DTcms.Model.sys_model();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    List<DTcms.Model.sys_model_nav> models = new List<DTcms.Model.sys_model_nav>();
                    DTcms.Model.sys_model_nav modelt;
                    for (int n = 0; n < i; n++)
                    {
                        modelt = new DTcms.Model.sys_model_nav();
