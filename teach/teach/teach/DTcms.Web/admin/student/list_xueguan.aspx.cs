...
{
    public partial class list_xueguan  : DTcms.Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("list_xueguan.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("list_xueguan.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("list_xueguan.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
