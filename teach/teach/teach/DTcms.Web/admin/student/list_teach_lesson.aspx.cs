...
namespace DTcms.Web.admin.student
{
    public partial class list_teach_lesson : DTcms.Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("list_teach_lesson.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&user_id={4}",
               this.channel_id.ToString(), this.category_id.ToString(), this.keywords, ddlProperty.SelectedValue,this.user_id.ToString()));
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("list_teach_lesson.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&user_id={4}&page={5}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("list_teach_lesson.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&user_id={4}",
