<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="photo_edit.aspx.cs" Inherits="DTcms.Web.admin.photo.photo_edit" ValidateRequest="false" %>
...
<div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; 图文管理 &gt; 编辑信息</div>
<div id="contentTab">
    <ul class="tab_nav">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>参考价格：</th>
                <td><asp:TextBox ID="txtMarketPrice" runat="server" CssClass="txtInput small required number" maxlength="10">0</asp:TextBox></td>
            </tr>
            <tr>
                <th>销售价格：</th>
                <td><asp:TextBox ID="txtSellPrice" runat="server" CssClass="txtInput small required number" maxlength="10">0</asp:TextBox></td>
            </tr>
            <tr>
                <th>排序数字：</th>
            ...
            <tr>
                <th valign="top" style="padding-top:10px;">图文相册：</th>
                <td>
    ...
    <div class="tab_con">
        <table class="form_table">
            ...
            <tr>
                <th>图文编号：</th>
                <td><asp:TextBox ID="txtPhotoNo" runat="server" CssClass="txtInput normal" maxlength="100" /></td>
            </tr>
            <tr>
                <th>赞成人数：</th>
                <td><asp:TextBox ID="txtDiggGood" runat="server" CssClass="txtInput small required digits" maxlength="10" ReadOnly="True">0</asp:TextBox></td>
            </tr>
            <tr>
                <th>反对人数：</th>
                <td><asp:TextBox ID="txtDiggAct" runat="server" CssClass="txtInput small required digits" maxlength="10" ReadOnly="True">0</asp:TextBox></td>
            </tr>
            <tr>
                <th>URL链接：</th>
