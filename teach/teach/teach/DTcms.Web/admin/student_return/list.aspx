<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="DTcms.Web.admin.student_return.list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 学员回访记录 &gt; 管理列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <asp:LinkButton ID="lbAll" runat="server" onclick="lbAll_Click"
             ...
             <asp:LinkButton ID="lbTwo" runat="server" CommandArgument="2" 
                ...
                <asp:LinkButton ID="lbSeven" runat="server" CommandArgument="7" onclick="lbSeven_Click">7天未回访</asp:LinkButton>&nbsp;&nbsp;
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        ...
        <th width="7%" align="center">上次回访时间</th>
        <th width="7%" align="center">本月回访次数</th>
        <th width="11%">操作</th>
      </tr>
    </HeaderTemplate>
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><%#Eval("return_count")%></td>
        <td align="center"><%#string.Format("{0:d}", Eval("last_return_time"))%></td>
          <td align="center"><%=yearCount %>年<%=monthCount%>月份：<%#getReturnMonth(int.Parse(Eval("id").ToString()), monthCount, yearCount)%></td>
        <td align="center">&nbsp;<a href="list_view.aspx?channel_id=<%#this.channel_id %>&user_id=<%#Eval("id")%>">记录详情</a>
        &nbsp;<a href="../teach_return/list.aspx?channel_id=<%#this.channel_id %>&user_id=<%#Eval("id") %>">反馈记录</a>
        </td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
