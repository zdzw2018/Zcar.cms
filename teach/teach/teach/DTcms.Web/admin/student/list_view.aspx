...
<form id="form1" runat="server">
      ...
      <tr>
        ...
        <th width="5%" align="center">年级</th>
         ...
         <th width="5%" align="center">剩余课时</th>
          ...
          <th width="5%" align="center">剩余赠送课时</th>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><%#(getTotalKeShi(int.Parse(Eval("id").ToString())) - getKeShi1(int.Parse(Eval("id").ToString()))).ToString("0.0")%></td>
      
           <td align="center"><%#(getGiveTotalKeShi(int.Parse(Eval("id").ToString())) - getGiveKeShi(int.Parse(Eval("id").ToString()))).ToString("0.0")%></td>
          <td align="center"><%=yearCount %>年<%=monthCount%>月份：<%#getKeShiMonth(int.Parse(Eval("id").ToString()), monthCount,yearCount)%>课时,<%#getGiveKeShiMonth(int.Parse(Eval("id").ToString()), monthCount,yearCount)%>赠送课时</td>
        <td align="center">
