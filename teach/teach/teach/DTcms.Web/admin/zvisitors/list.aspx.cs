        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (model.role_id != 1 && model.role_id != 15 && model.role_id != 16)
                {
                    ...
                    RptBind("id>0 and user_id=" + model.id + CombSqlTxt(this.channel_id, this.category_id, this.keywords, this.property, this.visiting_nature), "add_time desc");
                }
                else
                {
                    RptBind("id>0 and xiaoqu="+model.xiaoqu + CombSqlTxt(this.channel_id, this.category_id, this.keywords, this.property, this.visiting_nature), "add_time desc");
