        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (GetAdminInfo().role_id != 1)
                {
                    ...
                    RptBind("id>0 and user_id=" + GetAdminInfo().id + CombSqlTxt(this.channel_id, this.category_id, this.keywords, this.property,this.zixun), "add_time desc");
                }
                else
                {
                    RptBind("id>0" + CombSqlTxt(this.channel_id, this.category_id, this.keywords, this.property,this.zixun), "add_time desc");
                }
            }
        }
