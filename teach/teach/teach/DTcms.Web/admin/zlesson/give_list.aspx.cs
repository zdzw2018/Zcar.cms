...
{
    public partial class give_list : DTcms.Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("give_list.aspx", "category_id={0}&keywords={1}&property={2}&teacher={3}&kemu={4}&year={5}&month={6}&start_time={7}&end_time={8}&stuid={9}&channel_id={10}&grade={11}&leftkeshi={12}&xueguan={13}", new string[] { this.category_id.ToString(), this.keywords, this.property, this.ddlTeacher.SelectedValue, this.ddlLesson.SelectedValue, this.yearCount.ToString(), this.monthCount.ToString(), this.txtStartTime.Text, this.txtEndTime.Text, this.stuid.ToString(), this.channel_id.ToString(), this.grade, this.leftkeshi.ToString(), this.ddlXueGuan.SelectedValue }));
        }

        protected void btnSearch_Click(object sender, EventArgs e)
        {

            Response.Redirect(Utils.CombUrlTxt("give_list.aspx", "category_id={0}&keywords={1}&property={2}&teacher={3}&kemu={4}&year={5}&month={6}&start_time={7}&end_time={8}&stuid={9}&channel_id={10}&grade={11}&leftkeshi={12}&xueguan={13}", new string[] { this.category_id.ToString(), this.txtKeywords.Text, this.property, this.ddlTeacher.SelectedValue, this.ddlLesson.SelectedValue, this.yearCount.ToString(), this.monthCount.ToString(), this.txtStartTime.Text, this.txtEndTime.Text, this.stuid.ToString(), this.channel_id.ToString(), this.grade, this.leftkeshi.ToString(),this.xueguan }));
        ...
        protected void ddlGrade_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("give_list.aspx", "category_id={0}&keywords={1}&property={2}&teacher={3}&kemu={4}&year={5}&month={6}&start_time={7}&end_time={8}&stuid={9}&channel_id={10}&grade={11}&leftkeshi={12}&xueguan={13}", new string[] { this.category_id.ToString(), this.keywords, this.property, this.ddlTeacher.SelectedValue, this.ddlLesson.SelectedValue, this.yearCount.ToString(), this.monthCount.ToString(), this.txtStartTime.Text, this.txtEndTime.Text, this.stuid.ToString(), this.channel_id.ToString(), this.ddlGrade.SelectedValue, this.leftkeshi.ToString(),this.xueguan }));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (this.stuid != 0)
                {
                    this.RptBind("id>0 and stu_id=" + this.stuid + this.CombSqlTxt(this.category_id, this.keywords, this.property, this.teacher,this.xueguan, this.kemu, this.yearCount.ToString(),this.monthCount.ToString(),this.start_time.ToString(), this.end_time.ToString(), this.grade), "add_time desc");
                }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            DTcms.BLL.give_lesson lesson = new DTcms.BLL.give_lesson();
            ...
            string linkUrl = Utils.CombUrlTxt("give_list.aspx", "category_id={0}&keywords={1}&property={2}&teacher={3}&kemu={4}&year={5}&month={6}&start_time={7}&end_time={8}&stuid={9}&channel_id={10}&grade={11}&page={12}&leftkeshi={13}&xueguan={14}", new string[] { this.category_id.ToString(), this.keywords, this.property, this.teacher, this.kemu, this.yearCount.ToString(), this.monthCount.ToString(), this.start_time.ToString(), this.end_time.ToString(), this.stuid.ToString(), this.channel_id.ToString(), this.ddlGrade.SelectedValue, "__id__", this.leftkeshi.ToString(),this.xueguan });
        ...
        protected void shanchu(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功！", Utils.CombUrlTxt("give_list.aspx", "category_id={0}&keywords={1}&property={2}&teacher={3}&kemu={4}&year={5}&month={6}&start_time={7}&end_time={8}&stuid={9}&channel_id={10}&grade={11}&leftkeshi={12}&xueguan={13}", new string[] { this.category_id.ToString(), this.txtKeywords.Text, this.property, this.ddlTeacher.SelectedValue, this.ddlLesson.SelectedValue, this.yearCount.ToString(), this.monthCount.ToString(), this.txtStartTime.Text, this.txtEndTime.Text, this.stuid.ToString(), this.channel_id.ToString(), this.grade, this.leftkeshi.ToString(), this.xueguan }), "Success");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("give_list.aspx", "category_id={0}&keywords={1}&property={2}&teacher={3}&kemu={4}&year={5}&month={6}&start_time={7}&end_time={8}&stuid={9}&channel_id={10}&grade={11}&leftkeshi={12}&xueguan={13}", new string[] { this.category_id.ToString(), this.keywords, this.property, this.ddlTeacher.SelectedValue, this.ddlLesson.SelectedValue, this.ddlYear.SelectedValue, this.ddlMonth.SelectedValue, this.txtStartTime.Text, this.txtEndTime.Text, this.stuid.ToString(), this.channel_id.ToString(), this.grade, this.leftkeshi.ToString(),this.xueguan }));
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Context.Response.AddHeader("Content-Disposition", "attachment; filename=" + HttpUtility.UrlEncode("giveexcel.xls")); //解决中文文件名乱码    
