...
{
    public partial class photo_list : DTcms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.prolistview = Utils.GetCookie("photo_list_view"); //显示方式
            if (!Page.IsPostBack)
            {
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("photo_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("photo_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        {
            Utils.WriteCookie("photo_list_view", "Txt", 43200);
            Response.Redirect(Utils.CombUrlTxt("photo_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        {
            Utils.WriteCookie("photo_list_view", "Img", 43200);
            Response.Redirect(Utils.CombUrlTxt("photo_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, this.page.ToString()));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("photo_page_size", _pagesize.ToString(), 43200);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("photo_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
