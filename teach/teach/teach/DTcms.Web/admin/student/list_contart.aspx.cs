    ...
    public partial class list_contart : DTcms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                {
                    RptBind(" id>0 and stu_id in(select stu_id from tb_student_contract where audit_stutas=1 and xiaoqu=" + model.xiaoqu + ")" + CombSqlTxt(this.channel_id, this.category_id, this.keywords, this.property, this.grade, this.tween, this.xueguan), "Expr2 desc");
                }
            }
        }
