<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jianzhi_teacher_wages.aspx.cs" Inherits="DTcms.Web.admin.zlesson.jianzhi_teacher_wages" %>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><%#(decimal.Parse(getKeShiDanJia(int.Parse(Eval("manager_id").ToString()),int.Parse(Eval("stu_id").ToString())))*getKeShiMultiple(int.Parse(Eval("stu_id").ToString()))).ToString("0.0") %></td>
                    <td align="center"><%#(decimal.Parse(getKeShiDanJia(int.Parse(Eval("manager_id").ToString()),int.Parse(Eval("stu_id").ToString())))*decimal.Parse(Eval("lesson_count").ToString())*getKeShiMultiple(int.Parse(Eval("stu_id").ToString()))).ToString("0.0") %></td>
