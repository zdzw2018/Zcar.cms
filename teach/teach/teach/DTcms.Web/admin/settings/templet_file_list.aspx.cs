...
{
    public partial class templet_file_list : DTcms.Web.UI.ManagePage
    {
        protected string skinName; //模板目录
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("sys_templet", ActionEnum.View.ToString()); //检查权限
                RptBind(skinName);
            }
        }
        ...
        {
            ChkAdminLevel("sys_templet", ActionEnum.Delete.ToString()); //检查权限
            ...
            JscriptMsg("文件删除成功啦！", Utils.CombUrlTxt("templet_file_list.aspx", "skin={0}", this.skinName), "Success");
        }
    }
}