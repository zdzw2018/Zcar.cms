...
{
    public partial class keshi_jili_list : DTcms.Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("keshi_jili_list.aspx", "channel_id={0}&keywords={1}&page={2}",
        ...
        protected string CombSqlTxt(int _channel_id, string _keywords)
        {
            ...
            {
                strTemp.Append(" and total_begin like '%" + _keywords + "%'");
            }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("keshi_jili_list.aspx", "channel_id={0}&keywords={1}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("keshi_jili_list.aspx", "channel_id={0}&keywords={1}",
