...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <asp:LinkButton ID="zeorHuiFan" runat="server" CommandArgument="0" onclick="zeorHuiFan_Click">0次回访</asp:LinkButton>&nbsp;&nbsp;
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center">
       <a href="list_xueguan.aspx?channel_id=<%#this.channel_id %>&user_id=<%#Eval("id")%>">添加学管师</a>
        </td>
