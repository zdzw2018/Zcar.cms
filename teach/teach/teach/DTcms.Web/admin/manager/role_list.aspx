...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
		    ...
		    <a href="role_edit.aspx?action=<%=ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加角色</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="role_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("role_name")%></a></td>
        <td align="center"><%#GetTypeName( Convert.ToInt32(Eval("role_type")))%></td>
        <td align="center"><a href="role_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
