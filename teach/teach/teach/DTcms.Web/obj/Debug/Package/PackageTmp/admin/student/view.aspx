...
<body class="mainbody">
        ...
        <table class="form_table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txt_stu_parent_name" runat="server"  CssClass="txtInput normal" maxlength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>学生姓名：</th>
                <td>
                 <asp:TextBox ID="txt_stu_name" runat="server"  CssClass="txtInput normal" maxlength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>联系电话：</th>
                <td>
                    ...
                    <asp:TextBox ID="txt_stu_tel" runat="server"  CssClass="txtInput normal" maxlength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>学校：</th>
                <td>
                     ...
                     <asp:TextBox ID="txt_stu_school" runat="server"  CssClass="txtInput normal" maxlength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>年级：</th>
                <td>
                    <asp:TextBox ID="txt_stu_grade" runat="server"  CssClass="txtInput normal" maxlength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>家庭住址：</th>
                <td>
                    ...
                    <asp:TextBox ID="txt_stu_addr" runat="server"  CssClass="txtInput normal" maxlength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>剩余课时：</th>
                <td>
                    ...
                    <asp:TextBox ID="txt_stu_lesson" runat="server"  CssClass="txtInput normal" maxlength="100"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>备注：</th>
                <td>
                    ...
                    <asp:TextBox ID="txt_stu_remark" runat="server"  CssClass="txtInput normal" maxlength="100"></asp:TextBox>
                </td>
            </tr>
    ...
    <div class="foot_btn_box">
         <asp:Button ID="btnSubmit" runat="server"   Text="修改合同" CssClass="btnSubmit" OnClick="btnSubmit_Click" Visible="false" />&nbsp;&nbsp;
