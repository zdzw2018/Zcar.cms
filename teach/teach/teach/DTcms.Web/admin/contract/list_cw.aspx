<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list_cw.aspx.cs" Inherits="DTcms.Web.admin.contract.list_cw" %>
...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <asp:LinkButton ID="btnDelete" runat="server" CssClass="tools_btn"  
             ...
             <asp:LinkButton ID="btnShenHeChengGong" runat="server" CssClass="tools_btn"  
                OnClientClick="return ExePostBack('btnShenHeChengGong');" onclick="btnShenHeChengGong_Click"><span><b class="">批量审核通过</b></span></asp:LinkButton>
      ...
      <tr>
       ...
       <th width="6%" align="center">年级</th>
        <th width="6%" align="center">签订课时</th>
          <th width="12%" align="center">赠送课时</th>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><%#Convert.ToDecimal(Eval("contract_lesson").ToString()).ToString("0.0")%></td>
        ...
        <td align="center"><%#new DTcms.BLL.manager().GetModel(int.Parse(Eval("user_id").ToString()))==null ? "管理员" : new DTcms.BLL.manager().GetModel(int.Parse(Eval("user_id").ToString())).real_name %></td>
