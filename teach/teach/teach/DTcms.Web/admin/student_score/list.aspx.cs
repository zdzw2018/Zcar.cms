    ...
    public partial class list : DTcms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                DataTable dt = new BLL.manager().GetList("role_id=12 and xiaoqu=" + model.xiaoqu).Tables[0];
                ...
                {
                    RptBind("id>0 and id in(select stu_id from tb_student_contract where audit_stutas=1 and xiaoqu=" + model.xiaoqu + ")" + CombSqlTxt(this.channel_id, this.category_id, this.keywords, this.property, this.xueguan), "add_time desc");
