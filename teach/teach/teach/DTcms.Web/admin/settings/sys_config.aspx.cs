...
{
    public partial class sys_config : DTcms.Web.UI.ManagePage
    {
        ...
        private void ShowInfo()
        {
            ...
            emailpassword.Attributes["value"] = model.emailpassword;
        ...
        {
            ChkAdminLevel("sys_config", ActionEnum.Edit.ToString()); //检查权限
            BLL.siteconfig bll = new BLL.siteconfig();
            Model.siteconfig model = bll.loadConfig(Utils.GetXmlMapPath("Configpath"));
            try
            {
                ...
                //判断密码是否更改
                if (model.emailpassword != emailpassword.Text.Trim())
