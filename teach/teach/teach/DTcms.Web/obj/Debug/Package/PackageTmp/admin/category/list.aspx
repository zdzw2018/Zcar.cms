...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
            <a href="edit.aspx?action=<%=ActionEnum.Add %>&channel_id=<%=this.channel_id %>" class="tools_btn"><span><b class="add">添加类别</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td>
            ...
            <a href="edit.aspx?action=<%#ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a>
        </td>
        <td><asp:TextBox ID="txtSortId" runat="server" Text='<%#Eval("sort_id")%>' CssClass="txtInput2 small2" /></td>
        <td align="center"><a href="#">内容列表</a></td>
        <td align="center">
            <a href="edit.aspx?action=<%#ActionEnum.Add %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">添加子类</a>
            <a href="edit.aspx?action=<%#ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a>
        </td>
      </tr>
    </ItemTemplate>
