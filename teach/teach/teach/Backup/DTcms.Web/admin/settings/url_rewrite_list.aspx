...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
		    <a href="url_rewrite_edit.aspx?action=<%=ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加规则</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%#Eval("templet")%></td>
        <td align="center"><a href="url_rewrite_edit.aspx?action=<%#ActionEnum.Edit %>&name=<%#Eval("name")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
    </table>
