    ...
    public partial class list : DTcms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("id>0 and stu_id="+model.id + CombSqlTxt(this.channel_id, this.category_id, this.keywords, this.property), "return_time desc");
            }
        }
        #region 组合SQL查询语句==========================
        protected string CombSqlTxt(int _channel_id, int _category_id, string _keywords, string _property)
        {
            ...
            strTemp.Append(" and stu_id="+ user_id);
            //if (_channel_id > 0)
            //{
        ...
        protected void btnDelete1_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量审核成功啦！", Utils.CombUrlTxt("list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property), "Success");
        }
    }
}