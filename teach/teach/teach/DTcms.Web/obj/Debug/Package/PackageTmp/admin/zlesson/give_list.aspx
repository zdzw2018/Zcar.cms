<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="give_list.aspx.cs" Inherits="DTcms.Web.admin.zlesson.give_list" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>赠送课时信息管理</title>
...
<body class="mainbody">
    ...
    <div class="navigation">
       <a href="javascript:history.go(-1);" class="back">后退</a> 首页 &gt; 赠送课时安排管理 &gt; 管理列表</div>
    <div class="tools_box">
        <div class="tools_bar">
           ...
           <%if(Request.QueryString["leftkeshi"]!=null&&double.Parse(Request.QueryString["leftkeshi"].ToString())!=0.0){ %>
            <a href="give_lesson_edit.aspx?stuid=<%=this.stuid%>&channel_id=<%=this.channel_id %>&leftkeshi=<%=Request.QueryString["leftkeshi"].ToString() %>&user_id=<%=user_id %>" class="tools_btn"><span><b class="add">添加赠送课时</b></span></a>
            <%}%>
        ...
        <ItemTemplate>
            <tr>
                ...
                <%if (GetAdminInfo().role_id != 11)
                  { %>
                <td align="center">
                    <a href="give_lesson_edit.aspx?action=<%#ActionEnum.Edit %>&id=<%#Eval("id")%>&stuid=<%#Eval("stu_id") %>&channel_id=<%=this.channel_id %>&leftkeshi=<%=leftkeshi %>">
