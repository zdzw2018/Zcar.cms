<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bmlist.aspx.cs" Inherits="DTcms.Web.admin.yeji.bmlist" %>
...
<body>
   <form id="form1" runat="server">
    <div class="navigation">首页 &gt; 部门业绩管理 &gt; 管理列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
    ...
    <FooterTemplate>
         <tr>
            ...
            <td width="15%" align="center"> - </td>
            <td width="15%" align="center"> <%=totalnewmoney.ToString("0.00")%> </td>
            <td width="15%" align="center"><%=totalrealmoney.ToString("0.00")%></td>
            <td width="15%" align="center"><%=totalhetong%></td>
        </tr>
