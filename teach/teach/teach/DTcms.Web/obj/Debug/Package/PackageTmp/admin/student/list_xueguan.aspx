...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="list_fp.aspx?&channel_id=<%=this.channel_id %>&tpage=<%=tpage %>" class="tools_btn"><span><b class="return">学员列表</b></span></a>
            <a href="edit_xueguan.aspx?action=<%=ActionEnum.Add %>&channel_id=<%=this.channel_id %>&user_id=<%=user_id %>&tpage=<%=tpage %>" class="tools_btn"><span><b class="add">学管师</b></span></a>
            <a class="tools_btn" href="edit_fp.aspx?action=<%=ActionEnum.Add %>&channel_id=<%=this.channel_id %>&user_id=<%=user_id %>&tpage=<%=tpage %>"><span><b class="add">添加老师</b></span></a>
