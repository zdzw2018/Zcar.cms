        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                if (action == ActionEnum.Edit.ToString()) //修改
                {
                    ...
                    JscriptMsg("修改学生信息成功啦！", "list_xueguan.aspx?channel_id=" + this.channel_id + "&user_id=" + this.user_id, "Success");
                }
                else //添加
                {
                    ...
                    JscriptMsg("添加学生信息成功啦！", "list_xueguan.aspx?channel_id=" + this.channel_id + "&user_id=" + this.user_id, "Success");
                }
            }
            catch (Exception)
            {
