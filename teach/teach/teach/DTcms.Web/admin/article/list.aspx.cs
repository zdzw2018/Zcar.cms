...
namespace DTcms.Web.admin.article
{
    public partial class list : DTcms.Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect(getUrltxt(this.channel_id.ToString(), this.category_id.ToString(), this.txtKeywords.Text.Trim(), this.property, ""));
        }

        //筛选类别
        protected void ddlCategoryId_SelectedIndexChanged(object sender, EventArgs e)
        {
            Response.Redirect(getUrltxt(this.channel_id.ToString(), ddlCategoryId.SelectedValue, this.keywords, this.ddlProperty.SelectedValue, ""));
        }

        //筛选属性
        protected void ddlProperty_SelectedIndexChanged(object sender, EventArgs e)
        {
            Response.Redirect(getUrltxt(this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.ddlProperty.SelectedValue, ""));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(getUrltxt(this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, ""));
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功啦！", getUrltxt(this.channel_id.ToString(),this.category_id.ToString(),this.keywords,this.property,"") ,  "Success");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量删除成功啦！", getUrltxt(this.channel_id.ToString(),this.category_id.ToString(),this.keywords,this.property,""), "Success");
        }

        //统一链接
        public string getUrltxt(string _channel_id, string _category_id, string _keywords,string _property,string _page) 
        {
            return Utils.CombUrlTxt("list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
                _channel_id, _category_id, _keywords, _property, _page);
        }
