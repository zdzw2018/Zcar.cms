...
namespace DTcms.Web.admin.xgyj
{
    public partial class keshi : ManagePage
    {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("keshi.aspx", "channel_id={0}&month={1}&year={2}", new string[] { this.channel_id.ToString(), this.ddlMonth.SelectedValue, this.ddlYear.SelectedValue }));
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ChkAdminLevel(this.channel_id, ManagePage.ActionEnum.View.ToString());
        ...
        {
            this.rptList.DataSource = new student_teach().GetList(_strWhere, _groupBy);
