<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="DTcms.Web.admin.budget.list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 费用预算管理 &gt; 管理列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><%#Convert.ToDateTime( Eval("budget_date")).ToString("yyyy-MM")%></td>
        <td align="center" ><%#Eval("budget_publicity")%></td>
        <td align="center" ><%#Eval("budget_price")%></td>
