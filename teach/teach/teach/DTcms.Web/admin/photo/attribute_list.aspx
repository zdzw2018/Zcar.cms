<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_list.aspx.cs" Inherits="DTcms.Web.admin.photo.attribute_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 图文模块 &gt; 扩展属性</div>
    <div class="tools_box">
	    <div class="tools_bar">
		    <a href="attribute_edit.aspx?action=<%=ActionEnum.Add %>&channel_id=<%=this.channel_id %>" class="tools_btn"><span><b class="add">添加属性</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="attribute_edit.aspx?action=<%#ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
        <td><%#Eval("remark")%></td>
        <td><%#GetTypeCn(Convert.ToInt32(Eval("type")))%></td>
        <td align="center"><%#Eval("sort_id")%></td>
        <td align="center"><a href="attribute_edit.aspx?action=<%#ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a></td>
      </tr>
    </ItemTemplate>
