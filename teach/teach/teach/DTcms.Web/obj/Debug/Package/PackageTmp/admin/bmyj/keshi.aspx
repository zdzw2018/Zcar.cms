<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="keshi.aspx.cs" Inherits="DTcms.Web.admin.bmyj.keshi" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <th width="15%" align="center">姓名</th>
       ...
       <th align="center" width="10%">月份</th>
        ...
        <th align="center" width="10%">新签课时收入</th>
    ...
    <FooterTemplate>
       <tr>
            <td width="15%" align="center">总和：</td>
            <td width="10%" align="center"> - </td>
            <td width="10%" align="center"> - </td>
            <td width="10%" align="center"> <%=totalnewmoney.ToString("0.0")%> </td>
            <td width="10%" align="center"><%=totalrealmoney.ToString("0.0")%></td>
            <td width="10%" align="center"><%=totalhetong.ToString("0.0")%></td>
           <td width="10%" align="center"><%=total4.ToString("0.0") %></td>
            <td width="10%" align="center"> <%=(totalnewmoney+totalhetong).ToString("0.0")%> </td>
            <td width="10%" align="center"> <%=(totalrealmoney+total4).ToString("0.0") %> </td>
        </tr>
